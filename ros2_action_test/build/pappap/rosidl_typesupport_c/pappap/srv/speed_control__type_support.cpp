...
static const _SpeedControl_Request_type_support_symbol_names_t _SpeedControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pappap, srv, SpeedControl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pappap, srv, SpeedControl_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pappap, srv, SpeedControl_Request)() {
  return &::pappap::srv::rosidl_typesupport_c::SpeedControl_Request_message_type_support_handle;
}
...
static const _SpeedControl_Response_type_support_symbol_names_t _SpeedControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pappap, srv, SpeedControl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pappap, srv, SpeedControl_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pappap, srv, SpeedControl_Response)() {
  return &::pappap::srv::rosidl_typesupport_c::SpeedControl_Response_message_type_support_handle;
}
...
static const _SpeedControl_type_support_symbol_names_t _SpeedControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pappap, srv, SpeedControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pappap, srv, SpeedControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pappap, srv, SpeedControl)() {
  return &::pappap::srv::rosidl_typesupport_c::SpeedControl_service_type_support_handle;
}
