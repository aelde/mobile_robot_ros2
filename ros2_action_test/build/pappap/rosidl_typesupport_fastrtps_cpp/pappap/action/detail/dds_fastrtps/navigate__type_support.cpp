...
#include "pappap/action/detail/navigate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pappap::action::Navigate_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pappap::action::Navigate_Goal & ros_message)
{
  // Member: target
...
{
  auto typed_message =
    static_cast<const pappap::action::Navigate_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pappap::action::Navigate_Goal *>(
    untyped_ros_message);
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_Goal)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pappap
cdr_serialize(
  const pappap::action::Navigate_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: used_time
  cdr << ros_message.used_time;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pappap::action::Navigate_Result & ros_message)
{
  // Member: used_time
  cdr >> ros_message.used_time;
  ...
  size_t current_alignment)
{
  ...
  // Member: used_time
  {
    size_t item_size = sizeof(ros_message.used_time);
...
{
  auto typed_message =
    static_cast<const pappap::action::Navigate_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pappap::action::Navigate_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_Result)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pappap
cdr_serialize(
  const pappap::action::Navigate_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pappap::action::Navigate_Feedback & ros_message)
{
  // Member: distance_to_target
  cdr >> ros_message.distance_to_target;
...
{
  auto typed_message =
    static_cast<const pappap::action::Navigate_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pappap::action::Navigate_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_Feedback)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_Feedback__handle;
}
...
{
bool cdr_serialize(
  const pappap::action::Navigate_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  pappap::action::Navigate_Goal &);
size_t get_serialized_size(
  const pappap::action::Navigate_Goal &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pappap
cdr_serialize(
  const pappap::action::Navigate_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pappap::action::Navigate_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        pappap::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const pappap::action::Navigate_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pappap::action::Navigate_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_SendGoal_Request)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pappap
cdr_serialize(
  const pappap::action::Navigate_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pappap::action::Navigate_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const pappap::action::Navigate_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pappap::action::Navigate_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_SendGoal_Response)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_SendGoal_Response__handle;
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_SendGoal)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pappap
cdr_serialize(
  const pappap::action::Navigate_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pappap::action::Navigate_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
...
{
  auto typed_message =
    static_cast<const pappap::action::Navigate_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pappap::action::Navigate_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_GetResult_Request)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Request__handle;
}
...
{
bool cdr_serialize(
  const pappap::action::Navigate_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  pappap::action::Navigate_Result &);
size_t get_serialized_size(
  const pappap::action::Navigate_Result &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pappap
cdr_serialize(
  const pappap::action::Navigate_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pappap::action::Navigate_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        pappap::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const pappap::action::Navigate_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pappap::action::Navigate_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_GetResult_Response)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_GetResult_Response__handle;
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_GetResult)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_GetResult__handle;
}
...
{
bool cdr_serialize(
  const pappap::action::Navigate_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  pappap::action::Navigate_Feedback &);
size_t get_serialized_size(
  const pappap::action::Navigate_Feedback &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pappap
cdr_serialize(
  const pappap::action::Navigate_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pappap::action::Navigate_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        pappap::action::typesupport_fastrtps_cpp::max_serialized_size_Navigate_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const pappap::action::Navigate_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pappap::action::Navigate_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, action, Navigate_FeedbackMessage)() {
  return &pappap::action::typesupport_fastrtps_cpp::_Navigate_FeedbackMessage__handle;
}
