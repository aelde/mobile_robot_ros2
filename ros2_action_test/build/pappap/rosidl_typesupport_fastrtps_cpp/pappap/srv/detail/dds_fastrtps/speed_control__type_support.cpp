...
#include "pappap/srv/detail/speed_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const pappap::srv::SpeedControl_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pappap::srv::SpeedControl_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpeedControl_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pappap::srv::SpeedControl_Request *>(
...
static size_t _SpeedControl_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpeedControl_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpeedControl_Request__callbacks = {
  "pappap::srv",
...
static rosidl_message_type_support_t _SpeedControl_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpeedControl_Request__callbacks,
...
{
  return &pappap::srv::typesupport_fastrtps_cpp::_SpeedControl_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const pappap::srv::SpeedControl_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pappap::srv::SpeedControl_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpeedControl_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pappap::srv::SpeedControl_Response *>(
...
static size_t _SpeedControl_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpeedControl_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SpeedControl_Response__callbacks = {
  "pappap::srv",
...
static rosidl_message_type_support_t _SpeedControl_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpeedControl_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &pappap::srv::typesupport_fastrtps_cpp::_SpeedControl_Response__handle;
}
...
static service_type_support_callbacks_t _SpeedControl__callbacks = {
  "pappap::srv",
  "SpeedControl",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, srv, SpeedControl_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pappap, srv, SpeedControl_Response)(),
...
static rosidl_service_type_support_t _SpeedControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpeedControl__callbacks,
...
{
  return &pappap::srv::typesupport_fastrtps_cpp::_SpeedControl__handle;
}
